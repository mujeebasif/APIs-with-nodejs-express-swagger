...
var SWAGGER_UI_PATH    = '/';
const SWAGGER_UI_FILES = require('swagger-ui-dist').absolutePath(); //'./node_modules/swagger-ui-dist'
...
module.exports = function docsRouter(app,express) {
   // --------------------------- SwaggerUI -------------------------------------
   ...
   app.use(SWAGGER_UI_PATH, express.static(SWAGGER_UI_FILES));
};